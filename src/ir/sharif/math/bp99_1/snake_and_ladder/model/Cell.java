...
public class Cell {
    ...
    public boolean canEnter(Piece piece) {
        if (piece.getColor().equals(Color.YELLOW)) return this.piece == null;
        else return (Color.valueOf(piece.getColor().toString()).equals(color) || color.equals(Color.WHITE)) && this.piece == null;
    }
